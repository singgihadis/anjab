        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-8">
                            <span class="fa fa-lg fa-list-ol mr-1"></span> <b>Upaya Fisik  : <span id="nama_jabatan">-</span></b>
                        </div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th class="text-center nowrap">
                                    <a href="javascript:void(0);" onclick="modal_upaya_fisik(this)" class="btn btn-sm btn-primary"><span class="fa fa-hand-pointer-o"></span> Pilih</a>
                                </th>
                            </tr>
                            </thead>
                            <tbody id="listdata">
...
<!-- /#wrapper -->
<div id="modal_upaya_fisik" class="modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pilih Upaya Fisik</h5>
            ...
            <div class="modal-body">
                <div class="text-right">
                    <form id="form_filter_upaya_fisik" method="post">
                        <div class="d-inline-block">
                            <div class="input-group input-group-sm mb-3">
                                <div class="input-group-prepend">
                                    <button class="btn btn-primary" type="submit"><span class="fa fa-search"></span></button>
                                </div>
                                <input id="keyword_upayafisik" name="keyword_upayafisik" type="text" class="form-control" placeholder="Keyword">
                            </div>
                        </div>
                    </form>
                </div>
