        ...
        <div class="container-fluid">
            <div class="custom-breadcrumb mb-4">
                <ul>
                    ...
                    <li>Edit Kondisi Lingkungan Kerja</li>
                </ul>
            </div>
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <span class="fa fa-lg fa-edit mr-1"></span> <b>Edit Kondisi Lingkungan Kerja</b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/kondisi_lingkungan_kerja_edit.js"></script>
</body>
</html>
