        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-8">
                            <span class="fa fa-lg fa-list-ol mr-1"></span> <b>Kondisi Fisik  : <span id="nama_jabatan">-</span></b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/anjab_edit_syarat_jabatan_kondisi_fisik.js"></script>
</body>
</html>