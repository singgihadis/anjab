        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-8">
                            <span class="fa fa-lg fa-list-ol mr-1"></span> <b>Pengalaman Kerja  : <span id="nama_jabatan">-</span></b>
                        </div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                    <a href="javascript:void(0);" onclick="modal_pengalaman(true,this)" class="btn btn-sm btn-primary"><span class="fa fa-plus"></span></a>
                                </th>
                            </tr>
                            </thead>
                            <tbody id="listdata2">
...
<script type="text/javascript" src="/assets/js/page/anjab_edit_kualifikasi_pengalaman.js"></script>
</body>
</html>