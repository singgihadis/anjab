        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-8">
                            <span class="fa fa-lg fa-list-ol mr-1"></span> <b>Input Kelas Jabatan  : <span id="nama_jabatan">-</span></b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/anjab_edit_kelas_jabatan.js?v=<?php echo $this->config->item("js_version"); ?>"></script>
</body>
</html>
