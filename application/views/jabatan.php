                ...
                <div class="card-header bg-white">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a id="btn_tambah" href="/jabatan/tambah" class="btn btn-sm btn-primary"><span class="fa fa-plus"></span> Tambah</a>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="/assets/js/page/jabatan.js?v=<?php echo $this->config->item("js_version"); ?>"></script>
</body>
</html>
