        ...
        <div class="container-fluid">
            <div class="custom-breadcrumb mb-4">
                <ul>
                    ...
                    <li>Tambah Kamus Kompetensi SKJ</li>
                </ul>
            </div>
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <span class="fa fa-lg fa-edit mr-1"></span> <b>Tambah Kamus Kompetensi SKJ</b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/kamus_kompetensi_skj_tambah.js"></script>
</body>
</html>
