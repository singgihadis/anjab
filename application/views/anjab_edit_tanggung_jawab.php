        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-8">
                            <span class="fa fa-lg fa-list-ol mr-1"></span> <b>Tanggung Jawab : <span id="nama_jabatan">-</span></b>
                        </div>
                ...
                <div class="card-body" id="card-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody id="listdata_tanggungjawab">
                        <tr>
                            <td colspan="3">
                                Tunggu sebentar ...
                            </td>
...
<script type="text/javascript" src="/assets/js/page/anjab_edit_tanggung_jawab.js"></script>
</body>
</html>
