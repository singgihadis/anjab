        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <span class="fa fa-lg fa-edit mr-1"></span> <b>Edit Bakat Kerja</b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/bakat_kerja_edit.js"></script>
</body>
</html>
