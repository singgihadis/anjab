        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <span class="fa fa-lg fa-edit mr-1"></span> <b>Tambah Kondisi Fisik</b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/kondisi_fisik_tambah.js"></script>
</body>
</html>
