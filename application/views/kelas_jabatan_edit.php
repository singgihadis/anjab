        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <span class="fa fa-lg fa-edit mr-1"></span> <b>Edit Kelas Jabatan</b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/kelas_jabatan_edit.js"></script>
</body>
</html>
