        ...
        <div class="container-fluid">
            <div class="custom-breadcrumb mb-4">
                <ul>
                    ...
                    <li>Edit Fungsi Pekerjaan Orang</li>
                </ul>
            </div>
            <div class="card">
                <div class="card-header bg-white">
                    <div class="row">
                        <div class="col-md-6">
                            <span class="fa fa-lg fa-edit mr-1"></span> <b>Edit Fungsi Pekerjaan Orang</b>
                        </div>
...
<script type="text/javascript" src="/assets/js/page/fungsi_pekerjaan_orang_edit.js"></script>
</body>
</html>
