...
function load_data(){
    ...
    $.ajax({
        ...
        data:{page:page,nama:nama,tahun:filter_tahun},
        success:function(resp){
            ...
            if(res.is_error){
                ...
                $.each(res.data,function(k,v){
                    ...
                    html += "<td>" + v['tahun'] + "</td>";
                    html += "<td>" + v['kelas'] + "</td>";
                    html += "<td>" + FormatAngka(v['batas_awal']) + "</td>";
                    html += "<td>" + FormatAngka(v['batas_akhir']) + "</td>";
                    html += "<td class='nowrap'>";
                    html += "<a href='/kelas_jabatan/edit/" + v['id'] + "' class='btn btn-sm btn-light'><span class='fa fa-edit'></span></a> ";
