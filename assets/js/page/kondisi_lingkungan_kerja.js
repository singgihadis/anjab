...
function load_data(){
    ...
    $.ajax({
        type:'post',
        url:'/ajax/kondisi_lingkungan_kerja',
        ...
        success:function(resp){
            ...
            if(res.is_error){
                ...
                $.each(res.data,function(k,v){
                    ...
                    html += "<td>" + v['nama'] + "</td>";
                    html += "<td>";
                    html += "<a href='/kondisi_lingkungan_kerja/edit/" + v['id'] + "' class='btn btn-sm btn-light'><span class='fa fa-edit'></span></a> ";
        ...
        buttons: {
            ...
            confirm: {
                ...
                action: function(){
                    ...
                    $.ajax({
                        type:'post',
                        url:'/ajax/kondisi_lingkungan_kerja/hapus',
                        data:{id:id},
                        success:function(resp){
