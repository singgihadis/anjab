        ...
        success:function(resp){
            ...
            if(res.is_error){
                ...
                $.each(res.data,function(k,v){
                    ...
                    html += "<td>" + no + "</td>";
                    html += "<td>" + v['nama'] + "</td>";
                    html += "<td>" + FormatAngka(v['jml']) + "</td>";
                    html += "<td>";
                    html += "<a href='/keterangan_waktu/edit/" + v['id'] + "' class='btn btn-sm btn-light'><span class='fa fa-edit'></span></a> ";
        ...
        buttons: {
            ...
            confirm: {
                ...
                action: function(){
                    ...
                    $.ajax({
                        type:'post',
                        url:'/ajax/keterangan_waktu/hapus',
                        data:{id:id},
                        success:function(resp){
