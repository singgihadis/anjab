        ...
        success:function(resp){
            ...
            if(res.is_error){
                ...
                $.each(res.data,function(k,v){
                    ...
                    html += "<td>" + v['nama'] + "</td>";
                    html += "<td>";
                    html += "<a href='/urusan_pemerintahan/edit/" + v['id'] + "' class='btn btn-sm btn-light'><span class='fa fa-edit'></span></a> ";
        ...
        buttons: {
            ...
            confirm: {
                ...
                action: function(){
                    ...
                    $.ajax({
                        type:'post',
                        url:'/ajax/urusan_pemerintahan/hapus',
                        data:{id:id},
                        success:function(resp){
                            ...
                            if(res.is_error){
                                if(res.must_login){
                                    window.location = "/urusan_pemerintahan";
                                }else{
